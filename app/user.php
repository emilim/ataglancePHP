...
if (!isset($_SESSION['username'])) {
    ...
    echo file_get_contents("unregistered/account.html");
    exit();
}
...
<body>
        ...
        <ul class="navbar-nav">
            <li class="logo">
                <a href="#" class="nav-link">
                    <span class="link-text logo-text">At A Glance</span>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" onclick="notes();">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" id="newDrawing">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M20 11.08V8l-6-6H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h6" />
                        <path d="M14 3v5h5M18 21v-6M15 18h6" />
                    </svg>
                    <span class="link-text">New Drawing</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <div id="g_id_onload"
                data-client_id="737287686501-r210ijr6tg024h8u5o8429k8p93vlg6o.apps.googleusercontent.com"
                data-context="signin" data-ux_mode="popup" data-callback="onSignIn">
            </div>-->
    ...
    <main>
        ...
        <h2>Name: <strong><?php echo $_SESSION['username'] ?></strong></h2>
